<div>
    ...
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900">🏢 Warehouse Manager Approvals</h2>
        <p class="text-sm text-gray-500 mt-1">Waybills awaiting your approval</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-4 bg-gray-50">
            <p class="text-sm text-gray-500">Your Role</p>
            <p class="text-lg font-bold text-gray-900">🏢 Warehouse Manager</p>
        </div>
    </div>
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" wire:key="approval-modal">
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
                ...
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-4">
                    <p class="text-sm text-yellow-700">
                        ⚠️ This will forward the waybill to the <strong>Auditor</strong> for next approval.
                    </p>
                </div>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button wire:click="approveAsWarehouse"
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" wire:key="reject-modal">
        <div class="flex items-center justify-center min-h-screen px-4">

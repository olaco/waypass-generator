<div>
    ...
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900">📋 Auditor Approvals</h2>
        <p class="text-sm text-gray-500 mt-1">Waybills awaiting your audit approval</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-4 bg-gray-50">
            ...
            <p class="text-lg font-bold text-gray-900">📋 Auditor</p>
        </div>
    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-bold text-gray-900">Confirm Audit Approval</h3>
                ...
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-4">
                    <p class="text-sm text-yellow-700">
                        ⚠️ This will forward the waybill to the <strong>Supply Chain Manager</strong> for final approval.
                    </p>
                </div>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button wire:click="approveAsAuditor"
